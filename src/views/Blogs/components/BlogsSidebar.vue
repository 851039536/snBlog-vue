  ...
  <div id="blogs-sidebar">
    <div class="blogs-sidebar-main">
      ...
      <div class="blogs-sidebar-input">
        <div>
          <a-select show-search v-model:value="resData.title" placeholder="input search text" style="width: 100%;"
            :show-arrow="false" :filter-option="false" @search="SearchTitle" @select="skip">
            >
      ...
      <station-text title="站点统计" title1="文章数量" title2="总字符数" title3="热度" title4="最近更新" :res1="resData.ArticleCount"
        :res2="resData.textCount" :res3="resData.readCount" :res4="resData.articledata.substring(0, 10)"></station-text>
      <!-- end 站点统计 -->
    </div>
  </div>
</template>
